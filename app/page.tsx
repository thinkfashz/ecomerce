  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        {/* ── PRODUCTOS DESTACADOS: Sección oscura ───────────── */}
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <h2 className="section-heading mt-3 font-display text-5xl text-white lg:text-6xl text-balance">
                  Piezas elegidas para sentirse cálido, útil y vivido.
                </h2>
              </div>
              <Link
                href="/products"
            ...
            <div className="grid gap-5 lg:grid-cols-3">
              {categories.map((category) => (
                ...
                >
                  ...
                  />
                  <div>
                    <p className="text-xs uppercase tracking-[0.3em] text-white/40">Categoría</p>
                    ...
                    <div className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-accent">
                      Comprar ahora <ArrowRight className="size-3.5" />
                    </div>
                  </div>
                </Link>
              ))}
        ...
        {/* ── ÚLTIMOS PRODUCTOS: Sección oscura ─────────────── */}
        <section className="section-dark py-20 lg:py-28" data-theme="dark">
          <div className="page-shell space-y-12">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <h2 className="section-heading mt-3 font-display text-5xl text-white lg:text-6xl">
                  Últimas llegadas para sala, comedor y descanso.
                </h2>
              </div>
              <Link
                href="/products"
